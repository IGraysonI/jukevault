...
class PlaylistController {
    ...
    private val channelError = "jukevault_error"
    ...
    fun deletePlaylist(context: Context, result: MethodChannel.Result, call: MethodCall) {
        this.resolver = context.contentResolver
    ...
    fun removeFromPlaylist(context: Context, result: MethodChannel.Result, call: MethodCall) {
        ...
        try {
            ...
            Log.i("jukevault_error: ", e.toString())
