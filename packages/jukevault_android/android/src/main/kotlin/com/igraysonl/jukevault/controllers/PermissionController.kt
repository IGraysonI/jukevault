...
import com.igraysonl.jukevault.interfaces.PermissionManagerInterface
...
class PermissionController(
    ...
    override fun onRequestPermissionsResult(
        ...
        // [jukevault] plugin, so return [false] to indicate the [jukevault] plugin is not
        ...
        // When the incoming request code doesn't match the request codes defined by the jukevault
        // plugin return [false] to indicate the [jukevault] plugin is not handling the request
        ...
        // Return [true] here to indicate that the [jukevault] plugin handled the permission request
