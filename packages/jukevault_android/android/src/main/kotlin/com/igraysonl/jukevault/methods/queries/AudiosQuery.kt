...
import com.igraysonl.jukevault.types.checkAudioType
import com.igraysonl.jukevault.types.checkAudiosUriType
import com.igraysonl.jukevault.types.sorttypes.checkAudioSortType
...
class AudiosQuery : ViewModel() {
    ...
    fun init(
        ...
        // Define the [args]. Will be delivered from [result](From MethodChannel)
